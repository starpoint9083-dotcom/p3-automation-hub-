...
export function appHtml(){
  return v3Html()
    ...
    .replace('<div class="grid3"><div><label>네이버 블로그 주소</label><input id="pNaver"></div>', '<div class="grid2"><div><label>유튜브 채널 주소</label><input id="pYoutube" placeholder="https://youtube.com/@..."></div><div><label>네이버 블로그 주소</label><input id="pNaver"></div></div><div class="grid3"><div><label>네이버 블로그 주소</label><input id="pNaverMirror" style="display:none" aria-hidden="true"></div>')
