...
export function appHtml(){
  return v3Html()
    ...
    .replace('<button class="primary" id="makeMission">이번 주 홍보작전 짜기</button><div id="missionResult" class="plan" style="display:none"></div></div>', '<button class="primary" id="makeMission">이번 주 홍보작전 짜기</button><div id="missionResult" class="plan" style="display:none"></div><button class="secondary" id="startProduction" style="width:100%;margin-top:8px" disabled>이번 주 제작 전체 시작</button><div id="productionStatus" class="plan" style="display:none"></div></div>')
